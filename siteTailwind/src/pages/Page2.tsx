const Page2 = () => {
  return (
    <div className="relative  h-[200vh] w-full grid grid-cols-3 items-center justify-center gap-12   p-10">
      <div className="relative left-[0] top-[10px] h-[85%] w-[85%] rounded-imgCity1 overflow-hidden inline-block cursor-pointer group shadow-slate-200 shadow-2xl">
      ...
      <div className="relative left-[0] top-[10px] h-[85%] w-[85%] rounded-imgCity2 overflow-hidden inline-block cursor-pointer group shadow-slate-200  shadow-2xl">
        <div className="h-[100%] w-[100%]">
          <img
      ...
      <div className="relative left-[0] top-[10px] h-[85%] w-[85%] rounded-imgCity3 overflow-hidden inline-block cursor-pointer group shadow-slate-200  shadow-2xl">
        <div className="h-[100%] w-[100%]">
          <img
      ...
      <div className="relative left-[0] top-[10px] h-[85%] w-[85%] rounded-imgCity4 overflow-hidden inline-block cursor-pointer group shadow-slate-200  shadow-2xl">
        <div className="h-[100%] w-[100%]">
          <img
      ...
      <div className="relative left-[0] top-[10px] h-[85%] w-[85%] rounded-imgCity5 overflow-hidden inline-block cursor-pointer group shadow-slate-200  shadow-2xl">
        <div className="h-[100%] w-[100%]">
          <img
      ...
      <div className="relative left-[0] top-[10px] h-[85%] w-[85%] rounded-imgCity6 overflow-hidden inline-block cursor-pointer group shadow-slate-200  shadow-2xl">
        <div className="h-[100%] w-[100%]">
          <img
